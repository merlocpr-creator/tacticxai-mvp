...
# Recomendaciones básicas (reglas)
    ...
    if "messages_groq" not in st.session_state:
        st.session_state.messages_groq = [
            {"role": "system", "content": "Eres un asistente experto en táctica de fútbol. Tu apodo será DT. Responde en español con consejos aplicables y breves bullets cuando convenga, si te preguntan temas no relacionados a tactica de futbol, muestra error"}
        ]
